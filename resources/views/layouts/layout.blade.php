...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('css/main.css')}}" class="href">
    ...
    <body class="antialiased">
            ...
            <div class="jumbotron header">  
                <div class="row">
                    ...
                    <div class="float-left col-md-3">      
                        <img src="{{ asset('img/macros.png') }}" alt="" class="src">
                    </div>  
        ...
        <nav class="navbar  navbar-expand-md navbar-light bg-light sticky-top"> 
            ...
            <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a href="{{route('ingredients.index')}}" class="nav-link btn btn-outline-secondary"> 
                                Ingredients
                             </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('recettes.index')}}" class="nav-link btn btn-outline-secondary"> 
                                Recettes
                             </a>
                    </li>
                </ul>
